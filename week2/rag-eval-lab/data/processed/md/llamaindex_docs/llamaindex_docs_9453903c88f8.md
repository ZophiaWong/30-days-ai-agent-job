...
[SimpleDirectoryReader](/python/framework/module_guides/loading/simpledirectoryreader/)
...
[Section titled “Reading from subdirectories”](#reading-from-subdirectories)
...
[Section titled “Iterating over files as they load”](#iterating-over-files-as-they-load)
...
[Section titled “Restricting the files loaded”](#restricting-the-files-loaded)
...
[Section titled “Specifying file encoding”](#specifying-file-encoding)
...
[Section titled “Extracting metadata”](#extracting-metadata)
...
* `file_type`: the MIME type of the file, as guessed by [`mimetypes.guess\_type()](https://docs.python.org/3/library/mimetypes.html#mimetypes.guess_type) (string)
...
[Section titled “Date and time metadata”](#date-and-time-metadata)
...
[Section titled “Extending to other file types”](#extending-to-other-file-types)
...
[Section titled “Support for External FileSystems”](#support-for-external-filesystems)
...
## Node Parser Modules](/python/framework/module_guides/loading/node_parsers/modules/)[Next

---

## Model Context Protocol (MCP)](/python/framework/module_guides/mcp/)