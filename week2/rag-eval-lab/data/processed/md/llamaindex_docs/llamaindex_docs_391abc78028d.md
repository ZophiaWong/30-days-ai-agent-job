...
For a list of our supported LLMs and a comparison of their functionality,
check out our [LLM module guide](/python/framework/module_guides/models/llms).
...
[Section titled “Chat interface”](#chat-interface)
...
[Section titled “Specifying models”](#specifying-models)
...
[Section titled “Multi-Modal LLMs”](#multi-modal-llms)
...
[Section titled “Available LLMs”](#available-llms)
...
A general note on privacy and LLM usage can be found on the [privacy
page](/python/framework/understanding/privacy).

### Using a local LLM

[Section titled “Using a local LLM”](#using-a-local-llm)
...
## Building an LLM application](/python/framework/understanding/)[Next
