...
[Section titled “1. The Basics of asyncio”](#1-the-basics-of-asyncio)
...
[Section titled “2. Async Functions and await”](#2-async-functions-and-await)
...
[Section titled “3. Concurrency Explained”](#3-concurrency-explained)
...
[Section titled “4. Handling Blocking (Synchronous) Code”](#4-handling-blocking-synchronous-code)
...
[Section titled “5. A Practical Example”](#5-a-practical-example)
...
## RAG CLI](/python/framework/getting_started/starter_tools/rag_cli/)[Next
