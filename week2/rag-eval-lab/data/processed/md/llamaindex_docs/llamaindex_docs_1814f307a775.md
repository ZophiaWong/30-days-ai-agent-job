...
[installation](/python/framework/getting_started/installation) steps first.



Tip

Want to use local models? If you want to do our starter tutorial using only
local models, [check out this tutorial
instead](/python/framework/getting_started/starter_example_local).

## Set your OpenAI API key

[Section titled “Set your OpenAI API key”](#set-your-openai-api-key)
...
If you are using an OpenAI-Compatible API, you can use the `OpenAILike` LLM
class. You can find more information in the [OpenAILike
LLM](https://docs.llamaindex.ai/en/stable/api_reference/llms/openai_like/)
...
[Section titled “Basic Agent Example”](#basic-agent-example)
...
As you can see, we are using `async` python functions. Many LLMs and models
support async calls, and using async code is recommended to improve
performance of your application. To learn more about async code and python, we
recommend this [short section on async +
python](/python/framework/getting_started/async_python).

## Adding Chat History

[Section titled “Adding Chat History”](#adding-chat-history)
...
[Section titled “Adding RAG Capabilities”](#adding-rag-capabilities)
...
[Section titled “Storing the RAG Index”](#storing-the-rag-index)
...
If you used a [vector store
integration](/python/framework/module_guides/storing/vector_stores) besides
the default, chances are you can just reload from the vector store:
...
## How to read these docs](/python/framework/getting_started/reading/)[Next
