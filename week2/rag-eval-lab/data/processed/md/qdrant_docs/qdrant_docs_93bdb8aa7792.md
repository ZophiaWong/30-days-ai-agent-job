...
* [Hybrid and Multi-Stage Queries](#hybrid-and-multi-stage-queries)
  + [Hybrid Search](#hybrid-search)
    - [Reciprocal Rank Fusion (RRF)](#reciprocal-rank-fusion-rrf)
    - [Distribution-Based Score Fusion (DBSF)](#distribution-based-score-fusion-dbsf)
  + [Multi-stage queries](#multi-stage-queries)
    - [Re-scoring examples](#re-scoring-examples)
  + [Grouping](#grouping)
