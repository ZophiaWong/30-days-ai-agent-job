...
* [Collections](#collections)
  ...
  + [Create a collection](#create-a-collection)
    - [Collection with multiple vectors](#collection-with-multiple-vectors)
    - [Vector datatypes](#vector-datatypes)
    - [Collection with sparse vectors](#collection-with-sparse-vectors)
  ...
  + [Update collection parameters](#update-collection-parameters)
  + [Collection info](#collection-info)
    - [Grey collection status](#grey-collection-status)
    - [Approximate point and vector counts](#approximate-point-and-vector-counts)
  ...
  + [Collection aliases](#collection-aliases)
    ...
    - [List collection aliases](#list-collection-aliases)
