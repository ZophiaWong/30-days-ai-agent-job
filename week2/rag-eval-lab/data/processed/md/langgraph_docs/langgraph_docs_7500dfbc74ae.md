...
## [​](#1-define-tools-and-model) 1. Define tools and model
...
## [​](#3-define-model-node) 3. Define model node
...
## [​](#4-define-tool-node) 4. Define tool node
...
## [​](#5-define-end-logic) 5. Define end logic
...
## [​](#6-build-and-compile-the-agent) 6. Build and compile the agent
...
## [​](#1-define-tools-and-model-2) 1. Define tools and model
...
## [​](#2-define-model-node) 2. Define model node
...
## [​](#3-define-tool-node) 3. Define tool node
...
Previous](/oss/python/langgraph/install)[Run a local server

Next](/oss/python/langgraph/local-server)
