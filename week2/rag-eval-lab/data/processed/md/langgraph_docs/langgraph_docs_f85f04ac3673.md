...
* [Add short-term memory](#add-short-term-memory)
* [Use in production](#use-in-production)
* [Use in subgraphs](#use-in-subgraphs)
* [Add long-term memory](#add-long-term-memory)
* [Access the store inside nodes](#access-the-store-inside-nodes)
* [Use in production](#use-in-production-2)
...
* [View thread state](#view-thread-state)
* [View the history of the thread](#view-the-history-of-the-thread)
* [Delete all checkpoints for a thread](#delete-all-checkpoints-for-a-thread)
...
### [​](#use-in-production-2) Use in production
...
Previous](/oss/python/langgraph/use-time-travel)[Subgraphs

Next](/oss/python/langgraph/use-subgraphs)
