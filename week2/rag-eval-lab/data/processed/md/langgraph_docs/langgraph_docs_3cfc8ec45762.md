...
* [Send](#send)
* [Command](#command)
* [Return from nodes](#return-from-nodes)
* [update and goto](#update-and-goto)
* [graph](#graph)
* [Input to invoke/stream](#input-to-invoke%2Fstream)
* [resume](#resume)
* [Return from tools](#return-from-tools)
* [Graph migrations](#graph-migrations)
* [Runtime context](#runtime-context)
* [Recursion limit](#recursion-limit)
* [Accessing and handling the recursion counter](#accessing-and-handling-the-recursion-counter)
* [How it works](#how-it-works)
* [Accessing the current step counter](#accessing-the-current-step-counter)
* [Proactive recursion handling](#proactive-recursion-handling)
* [Proactive vs reactive approaches](#proactive-vs-reactive-approaches)
* [Other available metadata](#other-available-metadata)
...
[Graph API](/oss/python/langgraph/choosing-apis)
...
### [​](#input-to-invoke/stream) Input to `invoke`/`stream`
...
Previous](/oss/python/langgraph/choosing-apis)[Use the graph API

Next](/oss/python/langgraph/use-graph-api)
